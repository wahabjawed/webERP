<%@ Page Title="Performa Invoice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuoteInsert.aspx.cs" Inherits="ERP.QuoteInsert" %>
                ...
                <table style="width: 100%">
                    <tr>
                        <td style="width: 50%">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label14" runat="server" Text="Insurance" CssClass="col-md-3 control-label"></asp:Label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label17" runat="server" Text="Special Instruction" CssClass="col-md-3 control-label"></asp:Label>
                                <div class="col-md-9">
