...
function AddArticle() {
    ...
    articleTabContent += '<div class="col-sm-10">';
    articleTabContent += '<input type="number" class="form-control" id="inputCurrency' + articleCounter + '" onkeyup="calc(' + articleCounter + ');" name="inputCurrency' + articleCounter + '" placeholder="Currency" required >';
    articleTabContent += '</div>';
    articleTabContent += '</div>';
    articleTabContent += '<div class="form-group">';
...
function calc(val) {
    ...
    var currency = parseInt($("#inputCurrency" + counter).val());
